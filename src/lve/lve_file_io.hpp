...
namespace lve
{
    ...
    {
    public:
        LveYamlConfig() = default;
        LveYamlConfig(const std::string &yamlFilePath) : config{YAML::LoadFile(yamlFilePath)} {}

        LveYamlConfig(const LveYamlConfig &) = delete;
        LveYamlConfig &operator=(const LveYamlConfig &) = delete;
