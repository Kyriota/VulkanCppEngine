...
namespace lve
{
    ...
    void RendererApp::run()
    {
        ...
        graphicPipelineConfigInfo.vertexBindingDescriptions = Model::Vertex::getBindingDescriptions();
        graphicPipelineConfigInfo.vertexAttributeDescriptions = Model::Vertex::getAttributeDescriptions();
    ...
    void RendererApp::loadGameObjects()
    {
        ...
        std::shared_ptr<Model> lveModel =
            Model::createModelFromFile(lveDevice, modelRoot + "flat_vase.obj");
        ...
        lveModel = Model::createModelFromFile(lveDevice, modelRoot + "smooth_vase.obj");
        ...
        lveModel = Model::createModelFromFile(lveDevice, modelRoot + "quad.obj");
